...
import { Col, Row, Box, Form, Alert, CampoTexto, Button, TipoBotao, TipoAlerta } from "@intechprev/componentes-web";
                    ...
                    <Col>
                        <Box titulo={""}>
                            <Form ref={this.form}>
                                ...
                                <CampoTexto contexto={this} nome={"mensagem"} max={4000} valor={this.state.mensagem} rows={10} label={"Mensagem"} obrigatorio textarea />
