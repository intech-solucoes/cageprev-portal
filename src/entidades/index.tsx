...
import ComprovanteRendimentosEntidade from "./ComprovanteRendimentosEntidade";
import ContratoEmprestimoEntidade from "./ContratoEmprestimoEntidade";
import ContratoTrabalhoEntidade from "./ContratoTrabalhoEntidade";
import DadosPessoaisEntidade from "./DadosPessoaisEntidade";
import DependenteEntidade from "./DependenteEntidade";
...
import IRRFFaixaCalculoEntidade from "./IRRFFaixaCalculoEntidade";
import IRRFFaixaRegressivoEntidade from "./IRRFFaixaRegressivoEntidade";
import PessoaFisicaEntidade from "./PessoaFisicaEntidade";
